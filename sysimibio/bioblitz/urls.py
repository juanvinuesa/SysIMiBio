...
from sysimibio.bioblitz.views import register_bioblitz_project, register_bioblitz_occurrences, \
    ...
    proj_occs_geojson, bioblitz_events_stats, bioblitz_events_geojson, observation_detail_geojson
...
urlpatterns = [
    ...
    path('bioblitz_events_occurrences_geojson/', bioblitz_events_geojson, name='bioblitz_events_geojson'),
    path('bioblitz_occurrence_detail_geojson/<int:pk>/', observation_detail_geojson, name='bioblitz_occurrence_geojson'),
