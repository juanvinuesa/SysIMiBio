...
class PermanentParcelFormTest(TestCase):
    ...
    def create_PermanentParcelForm(self, **kwargs):
        valid_form = dict(
            ...
            plot_choices=['Fiscal', ], obs='Parcela de prueba', latitude=-26, #Plot_choices una lista con un elemento para sacar el len()
            longitude=-54,
    ...
    def test_empty_form(self):
        ...
        self.assertIn('longitude', self.pp.fields) #todo como testar cuando el form tiene campo diferente al del model
